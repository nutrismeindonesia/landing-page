const NUTRISME_BUILD = "2026-07-21-23";
...
const TRANSLATIONS = {
  id: {
    ...
    "faq.kicker": "🌱 PERTANYAAN UMUM",
    "faq.title": "Yang Sering <span>Ditanyakan</span>",
    "faq.intro": "Temukan jawaban singkat mengenai pilihan paket, informasi nutrisi, pengiriman, dan promo Nutrisme.",
    "faq.q1": "Apa perbedaan Nutrisme Daily, Nutrisme Ready, dan Nutrisme Cook?",
    "faq.a1": "Nutrisme Daily berisi makanan segar yang dimasak dan diantar setiap hari. Nutrisme Ready berupa frozen meal yang tinggal dipanaskan, sedangkan Nutrisme Cook menyediakan bahan serta bumbu terukur untuk kamu masak sendiri.",
    "faq.q2": "Apakah informasi nutrisi tersedia pada setiap menu?",
    "faq.a2": "Ya. Setiap menu menampilkan informasi nutrisi seperti kalori, protein, karbohidrat, lemak, serat, serta informasi penting lainnya agar pilihan makanan lebih transparan.",
    "faq.q3": "Bagaimana cara memilih paket yang paling sesuai?",
    "faq.a3": "Pilih berdasarkan tingkat kepraktisan yang kamu butuhkan: siap disantap, cukup dipanaskan, atau tetap dimasak sendiri tanpa repot menyiapkan bahan. Tim Nutrisme akan membantu mengonfirmasi detail menu setelah kamu mengisi formulir.",
    "faq.q4": "Bagaimana proses pengiriman diatur?",
    "faq.a4": "Setelah formulir dikirim, tim Nutrisme akan menghubungimu melalui Instagram untuk mengonfirmasi paket, alamat, tanggal, dan jadwal pengiriman yang tersedia.",
    "faq.q5": "Bagaimana cara menikmati Nutrisme Ready dan Nutrisme Cook?",
    "faq.a5": "Nutrisme Ready cukup dipanaskan selama beberapa menit sebelum dinikmati. Untuk Nutrisme Cook, bahan dan bumbu sudah dipersiapkan dengan takaran yang terencana sehingga kamu dapat langsung mengikuti proses memasaknya.",
    "faq.q6": "Bagaimana cara mendapatkan promo pelanggan baru Rp100.000?",
    "faq.a6": "Promo berlaku otomatis pada pembayaran bulan pertama untuk semua paket tanpa kode promo. Kelayakan akan dikonfirmasi oleh tim Nutrisme berdasarkan riwayat pembayaran pelanggan.",
  ...
  en: {
    ...
    "faq.title": "Common <span>Questions</span>",
    "faq.intro": "Find quick answers about Nutrisme plans, nutrition information, delivery, and the new-customer offer.",
    "faq.q1": "What is the difference between Nutrisme Daily, Nutrisme Ready, and Nutrisme Cook?",
    "faq.a1": "Nutrisme Daily provides fresh meals cooked and delivered each day. Nutrisme Ready consists of frozen meals that only need reheating, while Nutrisme Cook provides portioned ingredients and spices for you to cook at home.",
    "faq.q2": "Is nutrition information available for every menu?",
    "faq.a2": "Yes. Every menu includes nutrition information such as calories, protein, carbohydrates, fat, fibre, and other relevant details to make your meal choices more transparent.",
    "faq.q3": "How do I choose the most suitable plan?",
    "faq.a3": "Choose the level of convenience you need: ready to eat, ready to heat, or ready to cook without preparing the ingredients yourself. The Nutrisme team will help confirm the menu details after you submit the form.",
    "faq.q4": "How is delivery arranged?",
    "faq.a4": "After you submit the form, the Nutrisme team will contact you through Instagram to confirm your plan, address, date, and an available delivery schedule.",
    "faq.q5": "How do I prepare Nutrisme Ready and Nutrisme Cook?",
    "faq.a5": "Nutrisme Ready only needs to be heated for a few minutes before serving. Nutrisme Cook comes with prepared, portioned ingredients and spices so you can proceed directly with the cooking steps.",
    "faq.q6": "How do I receive the Rp100,000 new-customer offer?",
    "faq.a6": "The offer is applied automatically to the first monthly payment for every plan, with no promo code required. Eligibility will be confirmed by the Nutrisme team based on the customer's payment history.",
